class Solution:
    def countVowelPermutation(self, n: int) -> int:
        ...
        for i in range(1, n):
            ...
            e_vowel_permutation_count[i] = (a_vowel_permutation_count[i - 1] + i_vowel_permutation_count[i - 1]) 
            i_vowel_permutation_count[i] = (e_vowel_permutation_count[i - 1] + o_vowel_permutation_count[i - 1]) 
            o_vowel_permutation_count[i] = (i_vowel_permutation_count[i - 1]) 
            u_vowel_permutation_count[i] = (i_vowel_permutation_count[i - 1] + o_vowel_permutation_count[i - 1]) 
