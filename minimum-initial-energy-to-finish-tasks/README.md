<h2>1665. Minimum Initial Energy to Finish Tasks</h2><h3>Hard</h3><hr><div><p>You are given an array <code>tasks</code> where <code>tasks[i] = [actual<sub>i</sub>, minimum<sub>i</sub>]</code>:</p>
